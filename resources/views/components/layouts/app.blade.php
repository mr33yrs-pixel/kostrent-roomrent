...
<head>
    ...
    <meta name="description" content="{{ $metaDescription ?? 'JaiPremiumKost - Premium boarding house rooms with comfortable living experience.' }}">
    
    <title>{{ $title ?? 'JaiPremiumKost' }}</title>
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="{{ route('home') }}" class="flex-shrink-0 flex items-center gap-3 group">
                        <!-- House Icon -->
                        <!-- Logo Image -->
                        <img src="{{ asset('images/jai_logo.svg') }}" alt="JAI Premium Kost" class="h-12 w-auto">
                    </a>
                </div>
