    ...
    <div class="bg-pastel-bg min-h-screen py-12 sm:py-24">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h1 class="text-4xl font-extrabold text-gray-900 sm:text-5xl tracking-tight">{{ __('messages.contact.title') }}</h1>
                <p class="mt-4 text-xl text-gray-500 max-w-2xl mx-auto">{{ __('messages.contact.subtitle') }}</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="p-8 sm:p-12 bg-pastel-green/10 flex flex-col justify-center">
                        <div class="space-y-8">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-6">
                                    <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wide">{{ __('messages.contact.address') }}</h3>
                                    <p class="mt-1 text-base font-semibold text-gray-900 whitespace-pre-line">{{ $siteSettings['contact_address'] ?? 'Address not set' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-6">
                                    <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wide">{{ __('messages.contact.email') }}</h3>
                                    <a href="mailto:{{ $siteSettings['contact_email'] ?? '' }}" class="mt-1 text-base font-semibold text-gray-900 hover:text-pastel-green transition-colors block">{{ $siteSettings['contact_email'] ?? '' }}</a>
                                </div>
                            </div>
                             ...
                             <div class="flex items-center">
                                ...
                                <div class="ml-6">
                                    ...
                                    <p class="mt-1 text-base font-semibold text-gray-900">{{ __('messages.contact.operating_hours') }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative bg-pastel-green p-8 sm:p-12 flex flex-col justify-center items-center text-center">
                        ...
                        <div class="relative z-10">
                            ...
                            <a href="https://wa.me/{{ $siteSettings['contact_whatsapp'] ?? config('app.whatsapp_number') }}?text={{ urlencode(__('messages.contact.whatsapp_message')) }}" target="_blank" class="inline-flex items-center justify-center px-8 py-4 border-2 border-white text-lg font-bold rounded-full shadow-lg text-pastel-green bg-white hover:bg-gray-100 transition-all transform hover:scale-105">
                                ...
                                {{ __('messages.contact.chat_whatsapp') }}
                            </a>
                        </div>
                    </div>
                </div>
