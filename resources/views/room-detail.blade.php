<x-layouts.app :title="'Jai\'s House - ' . $room->name">
            ...
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-500 mt-2">* {{ __('messages.rooms.minimum_rent') }}</p>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pt-8 mt-8">
                        @if($room->is_available)
                            <a href="https://wa.me/{{ preg_replace('/^0/', '62', $siteSettings['contact_whatsapp'] ?? config('app.whatsapp_number')) }}?text={{ urlencode(__('messages.room_detail.whatsapp_message', ['name' => $room->name])) }}" target="_blank" class="block w-full text-center py-4 bg-green-500 hover:bg-green-600 text-white rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex items-center justify-center">
