...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'JaiPremiumKost - ' . $room->name]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('JaiPremiumKost - ' . $room->name)]); ?>
            ...
            <div class="bg-white rounded-3xl shadow-lg overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <div class="border-t border-gray-200 pt-8 mt-8">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($room->is_available): ?>
                            <a href="https://wa.me/<?php echo e(preg_replace('/^0/', '62', $siteSettings['contact_whatsapp'] ?? '6281234567890')); ?>?text=<?php echo e(urlencode(__('messages.room_detail.whatsapp_message', ['name' => $room->name]))); ?>" target="_blank" class="block w-full text-center py-4 bg-green-500 hover:bg-green-600 text-white rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex items-center justify-center">
