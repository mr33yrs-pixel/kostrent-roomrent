...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Jai\'s House - ' . __('messages.rooms.title')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Jai\'s House - ' . __('messages.rooms.title'))]); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-16">
                        ...
                        <div class="bg-white rounded-3xl shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden group">
                            <div class="relative h-64 bg-gray-200 <?php echo e(!$room->is_available ? 'grayscale' : ''); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($room->images) && isset($room->images[0])): ?>
                                    <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($room->images[0])); ?>" alt="<?php echo e($room->name); ?>" loading="lazy" decoding="async" width="400" height="256" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                                <?php else: ?>
                            ...
                            <div class="p-6">
                                ...
                                <p class="text-xs text-gray-500 mb-3">* <?php echo e(__('messages.rooms.minimum_rent')); ?></p>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($premiumRooms->hasPages()): ?>
                    <div class="mt-8">
                        <?php echo e($premiumRooms->appends(['standard_page' => request('standard_page'), 'economic_page' => request('economic_page')])->links()); ?>
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($standardRooms->hasPages()): ?>
                    <div class="mt-8">
                        <?php echo e($standardRooms->appends(['premium_page' => request('premium_page'), 'economic_page' => request('economic_page')])->links()); ?>
            ...
            <div class="mt-16">
                <div class="flex items-center mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 border-b-4 border-gray-200 pb-2"><?php echo e(__('messages.rooms.economic_collection')); ?></h2>
                </div>
                
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $economicRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="bg-white rounded-3xl shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden group">
                            <div class="relative h-64 bg-gray-200 <?php echo e(!$room->is_available ? 'grayscale' : ''); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($room->images) && isset($room->images[0])): ?>
                                    <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($room->images[0])); ?>" alt="<?php echo e($room->name); ?>" loading="lazy" decoding="async" width="400" height="256" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                       <div class="col-span-full py-12 text-center text-gray-500 bg-white rounded-3xl">
                            <?php echo e(__('messages.rooms.no_economic')); ?>

                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($economicRooms->hasPages()): ?>
                    <div class="mt-8">
                        <?php echo e($economicRooms->appends(['premium_page' => request('premium_page'), 'standard_page' => request('standard_page')])->links()); ?>
